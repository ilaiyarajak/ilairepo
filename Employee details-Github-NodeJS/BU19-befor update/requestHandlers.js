...
//	console.log(rows.length);
 ...
 //  });
  ...
  response.write('<html><body>Record update failed. Go <a href="/updateshow" target="middle">back</a></body></html>');//input["empname"]);
